...
insert into app.ACTIVIDAD values(920,'Estudios en ingenieria','Proyecto ampliado sobre proyectos abstractos','ABIERTA','PENDIENTE','01/03/2020','02/05/2020','Madrid','System',8,'FORMACION',5,'ONG que cumple con los estatutos del estado',5,null)
...
insert into app.participacionenactividad values(400,'none','ACEPTADA','21/11/2020',null,null,null,2,600)
insert into app.participacionenactividad values(500,'none','ACEPTADA','01/12/2020',null,null,null,2,500)
insert into app.participacionenactividad values(210,'none','PENDIENTE','21/11/2020',null,null,null,2,600)
insert into app.participacionenactividad values(211,'none','PENDIENTE','01/12/2020',null,null,null,2,500)
insert into app.VALORACIONPUBLICA values (321,10,'actividad excelente',920,null,4)
insert into app.VALORACIONPUBLICA values (540,8,'actividad interesante',600,null,2)
insert into app.VALORACIONPUBLICA values (970,4,'actividad aburrida',500,null,3)
insert into app.ASIGNATURA values (123,4,'Fundamentos de electrónica',600)
insert into app.ASIGNATURA values (453,3,'Sistemas de información para internet',920)